...
> Postgres version [here](https://github.com/sourcefuse/loopback4-starter)

Database supported in this starter project is mysql. But you can use any other SQL database. You will need to replace _loopback-connector-mysql_ in dependencies with your required connector. If you are using mysql, follow as below.
Setup a [mysql](https://dev.mysql.com/) instance. Create a database named **todolist**.
